...
<div class="w-full p-5 mt-20 md:w-auto lg:w-4/6 xl:w-3/4">
    <div class="card">
        <div class="card-header">
            <h6 class="h6">Edit Jadwal Tutoring</h6>
        </div>
        <div class="card-body">
            <form action="{{route('mentor.schedule.update', ['schedule' => $schedule])}}" method="POST">
                ...
                <div class="grid gap-8">
                    ...
                    <div class="grid gap-2">
                        ...
                        <input type="time" class="form-input lg:w-3/5" id="jam_mulai" name="jam_mulai" value="{{old('jam_mulai') ?? $schedule->hour_start}}">
                        @error('jam_mulai')
                        <div class="mt-2 alert alert-error">
                            {{$message}}
                        </div>
                    ...
                    <div class="grid gap-2">
                        ...
                        <input type="time" class="form-input lg:w-3/5" id="jam_akhir" name="jam_akhir" value="{{old('jam_akhir') ?? $schedule->hour_end}}">
                        @error('jam_akhir')
                        <div class="mt-2 alert alert-error">
                            {{$message}}
                        </div>
