...
<body>
    ...
    <form action="{{route('mentor.course.submission.review-process', ['course' => $course->slug, 'submission' => $submission->slug, 'submissionUser' => $submissionUserAccepted])}}" method="post">
        @csrf
