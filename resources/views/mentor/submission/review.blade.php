...
<body>
    ...
    @endforeach
    <p><a href="{{route('mentor.course.submission.review-pending', ['course' => $course, 'submission' => $submission])}}">Detail</a></p>
    ...
    @endforeach
    <p><a href="{{route('mentor.course.submission.review-accepted', ['course' => $course, 'submission' => $submission])}}">Detail</a></p>
    ...
    @endforeach
    <p><a href="{{route('mentor.course.submission.review-rejected', ['course' => $course, 'submission' => $submission])}}">Detail</a></p>
