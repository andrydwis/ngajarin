    <!-- start sidebar -->
    <div id="sideBar" class="relative hidden w-64 p-6 bg-white border-r border-gray-300 md:flex md:flex-col md:flex-wrap md:flex-none md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
        ...
        <div class="flex flex-col">
            ...
            <!-- link -->
            <a href="./index-1.html" class="mb-3 text-sm font-medium capitalize transition duration-500 ease-in-out hover:text-green-600">
            ...
            <!-- link -->
            <a href="#" class="mb-3 text-sm font-medium capitalize transition duration-500 ease-in-out hover:text-green-600">
