    ...
    <div x-data="{isOpen4 : true}">
        ...
        <div :class="{'hidden' : isOpen4}"
                    @click.away="isOpen4 = !isOpen4" id="sideBar" 
                    class="fixed top-0 left-0 z-40 flex-col flex-wrap flex-none w-64 h-screen p-6 mt-0 bg-white border-r border-gray-200 lg:relative md:pt-4 md:top-16 lg:flex">
