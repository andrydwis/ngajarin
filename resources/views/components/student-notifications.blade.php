        ...
        <div x-cloak x-show.transition.origin.top="openDropdown" @click.away="openDropdown = false" class="fixed right-0 z-20 w-full mt-5 bg-white border-t-4 border-b-4 rounded shadow-md md:absolute border-primary-lighter md:w-80">
            ...
            <div class="flex flex-row items-center justify-between px-4 py-2 text-sm font-semibold capitalize">
                ...
                <div class="px-1 text-xs text-indigo-500 bg-indigo-100 border border-indigo-200 rounded">
                    <strong>{{-- $unreadNotifications->count() --}} 5 </strong>
                </div>
            </div>
            <hr>
            <!-- end top -->
                    ...
                    <a href="{{-- route('mentor.notification.handling', ['notification' => $notification]) --}}" class="flex px-4 py-4 text-sm tracking-wide transition-all duration-300 ease-in-out bg-white md:flex md:flex-row md:items-center md:justify-start hover:bg-gray-200">
                        ...
                        <div class="flex flex-col flex-1">
                            ...
                            <div class="text-gray-500">
                                {{-- $student->name --}} menjawab request tutoring yang anda ajukan
                            </div>
                   ...
                   {{--  @if(!$notification->read_at) --}}
                    ...
                    <a href="{{-- route('mentor.notification.handling', ['notification' => $notification]) --}}" class="flex px-4 py-4 text-sm tracking-wide transition-all duration-300 ease-in-out bg-white md:flex md:flex-row md:items-center md:justify-start hover:bg-gray-200">
                        ...
                        <div class="flex flex-col flex-1">
                            ...
                            <div class="text-gray-500">
                                <b>{{-- $student->name --}}</b> Telah Mereview submission {{-- $submission->title --}}
                            </div>
