...
<div class="w-full p-5 mx-auto mt-20 lg:mx-0 md:w-auto lg:w-4/6 xl:w-3/4">
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="h6">Submission {{$submission->title}} yang ditolak</h6>
        </div>
        <div class="card-body">
            ...
            <div class="container mb-4">
                <table class="w-auto text-left border" id="datatables">
                    ...
                    <tbody class="text-gray-700">
                        ...
                        @foreach($submissionUsersRejected as $submissionUserRejected)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-1 py-2 text-sm text-center border-b md:text-left md:text-base md:px-4" x-data="{ isOpen : false }">
                                ...
                                <!-- Modal-->
                                <x-modal-review-submission :action="route('admin.course.submission.review-process', ['course' => $course->slug, 'submission' => $submission->slug, 'submissionUser' => $submissionUserRejected])" />
