            ...
            <form action="{{route('admin.course.update', ['course' => $course])}}" method="post">
                ...
                <div class="grid gap-6">
                    <div>
                        ...
                        <input type="text" name="judul" id="judul" placeholder="Judul Course"
                        class="form-input py-2 mt-2 block w-full @error('judul') is-invalid @enderror" value="{{old('judul') ?? $course->title}}">
                        @error('judul')
                    ...
                    <div>
                        ...
                        class="form-textarea py-2 mt-2 block w-full @error('deskripsi') is-invalid @enderror">{!! old('deskripsi') ?? $course->description !!}</textarea>
                        @error('deskripsi')
                        <div class="alert alert-error">
                            {{$message}}
                        </div>
