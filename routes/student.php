...
Route::middleware(['auth', 'verified', 'role:student'])->group(function () {
    ...
    Route::delete('/student/classroom/member/destroy/{classroomMember}', [ClassroomMemberController::class, 'destroy'])->middleware(['password.confirm'])->name('student.classroom-member.destroy');
